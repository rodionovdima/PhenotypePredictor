...
#    - subsystems.txt - table of subsystems genes and their annotations
db_dir="database/"

# Number of parallel processes to use. Set in a range of 1-16
ncpu=16

echo "Dannotello pipeline"
...
# Annotating DIAMOND outputs using Danatello
mkdir -p annotation
ident=0.8
